<template>
  <main-layout>
    <div class="center my-auto darkmode-animation mb-auto">
      ...
      <div class="circle circle--inner">
        ...
        <div class="circle oh">
          ...
          <svg class="astronaut-wire max-h-96 mt-24" viewBox="-9 -9 259 823" width="350" height="2000">
            <path d="M241 0c-24 54-30 113-78 148S63 159 27 215c-35 55 32 102 73 141s103 94 98 166c-6 97-169 66-192 157-10 43-8 84 9 126" fill="none" stroke-width="6" stroke="#D2D2D2"></path>
          </svg>
      ...
      <div class="sorry">Oops! Sorry, not authorized.</div>
    </div>
  </main-layout>
</template>
...
.circle--outer {
  width: 550px;
  height: 550px;
  background-image: linear-gradient(to right bottom, #355ba1, #080a57);
  box-shadow: 0px 0px 20px -8px #000;
}
.circle--inner {
  width: 355px;
  height: 355px;
  background-image: linear-gradient(to right bottom, #4d4a2f, #c4a527);
  box-shadow: 0px 0px 20px -8px #000;
}
.four {
  position: absolute;
