    ...
    <div class="relative p-4 w-full max-w-xl h-full md:h-auto">
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
          <button @click="rename()" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create</button>
...
export default {
  name: 'CreateModal',
  props: ['extension', 'isFolder', 'currentFolder'],
  data () {
    return {
      newFileName: '',
      currentPath: ''
  ...
  watch: {
    ...
    'currentFolder' (newValue) {
      ...
      else this.currentPath = newValue + '/'
    }
  }
}
</script>
