  ...
  <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-800 shadow">
    <div class="container flex flex-wrap justify-between items-center mx-auto">
      <a href="home" class="flex items-center">
          ...
          <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">MoonNetic</span>
      </a>
      <div class="flex items-center md:order-2">
          ...
          <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown">
            <div class="py-3 px-4">
              <span class="block text-sm text-gray-900 dark:text-white">Cody Volz</span>
              <span class="block text-sm font-medium text-gray-500 truncate dark:text-gray-400">cody.volz@hotmail.com</span>
            </div>
            <ul class="py-1" aria-labelledby="dropdown">
              ...
              <li>
                <a href="settings" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Settings</a>
              </li>
              <li>
