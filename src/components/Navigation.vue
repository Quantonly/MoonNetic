  ...
  <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-darkmode-dark shadow">
    <div class="container flex flex-wrap justify-between items-center mx-auto">
      ...
      <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
        <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium" :class="[ this.$store.getters.accessToken ? 'md:mr-20' : 'md:mr-7' ]">
          <li>
          ...
          <li>
            <router-link to="/about" v-if="this.$route.fullPath === '/about'" class="darkmode-animation block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white" aria-current="page">About</router-link>
          ...
          <li>
            <router-link to="/contact" v-if="this.$route.fullPath === '/contact'" class="darkmode-animation block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white" aria-current="page">Contact</router-link>
